                ...
                <ul class="navbar-nav navbar-nav-hover ms-auto">
                  ...
                  <li class="nav-item ms-lg-auto">
                    <a class="nav-link nav-link-icon me-2" href=".">
                      ...
                      <p class="d-inline text-sm z-index-1 font-weight-bold" href=".">Masuk</p>
                    </a>
                  </li>
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-info shadow-info border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Masuk ke Dashboard</h4>
              ...
              <div class="card-body">
                <form autocomplete="off" role="form" class="text-start" method="post">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-info w-100 my-2 mb-2" name="masuk" >MASUK</button>
                  </div>
                  <div class="row">
                    <div class="col-8">
                      <p class="mt-4 text-sm">Belum memiliki akun? <a href="../akunbaru" class="text-info text-gradient font-weight-bold">Buat Akun</a></p>
                    </div>
                    <div class="col-4">
                      <p class="mt-4 text-sm text-end"><a href="../reset" class="text-info text-gradient font-weight-bold">Lupa Password?</a></p>
                    </div>
                  </div>
                  <?php
                  if(isset ($_POST['masuk'])){
                    ...
                    if($response->success){
                      ...
                      $sql = "SELECT * FROM akun WHERE username='$namaakun'";
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        ...
                        if($status=='1'){
                          ...
                          if (password_verify($katasandi,$hash)) {
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                              <p class="text-white text-sm py-0 my-0"><i class="material-icons text-md">thumb_down</i> <strong>Gagal!</strong> Kata sandi salah!</p>
                          ...
                          ?>
                          <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <p class="text-white text-sm py-0 my-0"><i class="material-icons text-md">thumb_down</i> <strong>Gagal!</strong> Akun <?php echo $namaakun; ?> belum aktif, silahkan lakukan aktivasi melalui email!</p>
                            <button type="submit" name="btnclose" class="btn-close lh-1 " data-bs-dismiss="alert" aria-label="Close"><span class="lh-1" aria-hidden="true">&times;</span></button>
                          </div>
                          <?php
                        }
                        ...
                        ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                          <p class="text-white text-sm py-0 my-0"><i class="material-icons text-md">thumb_down</i> <strong>Gagal!</strong> Akun <?php echo $namaakun; ?> tidak terdaftar!</p>
                          <button type="submit" name="btnclose" class="btn-close lh-1 " data-bs-dismiss="alert" aria-label="Close"><span class="lh-1" aria-hidden="true">&times;</span></button>
                        </div>
                        <?php
                      }
