...
$npknim = $_GET['id'];
$sql = "SELECT * FROM pengguna WHERE npknim=".$npknim."";
  ...
  <body class="g-sidenav-show">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-gradient-info" href="../../pengguna">
            <div class="text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              <li class="breadcrumb-item text-sm" aria-current="page"><a class="link opacity-7" href="../">Pengguna</a></li>
        ...
        <div class="row mb-4">
                ...
                <div class="timeline timeline-one-side">
                  <div class="timeline-block mb-3">
                    ...
                    <div class="timeline-content">
                      <h6 class="text-secondary text-xs font-weight-bold mt-1 mb-0">NPK / NIM</h6>
                  ...
                  <div class="timeline-block">
                    ...
                    <div class="timeline-content">
                      ...
                      <p class="text-dark text-sm font-weight-bold mt-1 mb-0"><?php print_r(md5($akun['password'])); ?></p>
                    </div>
                  </div>
                </div>
              </div>
                          ...
                          <select class="form-control mb-2" name="prodi">
                            ...
                            if ($result->num_rows > 0) {
                              while ($row = $result->fetch_assoc()) {
                                ?>
                                <option value="<?php echo $row['idprodi']; ?>"><?php echo $row['namaprodi']; ?></option>
                                <?php
                              }
                            }
                            ?>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            ...
            if(isset($_POST['simpan'])){
              ...
              $sqlfak = "SELECT *FROM prodi WHERE idprodi='$prodi'";
