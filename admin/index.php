              ...
              <div class="card-body p-3">
                <div class="row">
                  ...
                  <div class="col-md-2 text-end">
                    <a href="pengguna/edit?id=<?php print_r($data['npknim']); ?>">
                      <i class="fas fa-user-edit text-info text-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Profile"></i>
                    </a>
                  </div>
                </div>
                <div class="timeline timeline-one-side">
                  <div class="timeline-block mb-3">
                    ...
                    <div class="timeline-content">
                      <h6 class="text-secondary text-xs font-weight-bold mt-1 mb-0">NPK</h6>
                  ...
                  <div class="timeline-block mb-3">
                    ...
                    <div class="timeline-content">
                      <h6 class="text-secondary text-xs font-weight-bold mt-1 mb-0">Unit</h6>
                  ...
                  <div class="timeline-block mb-3">
                    <span class="timeline-step">
                      <i class="material-icons text-info text-gradient">account_circle</i>
                    </span>
                    <div class="timeline-content">
