...
$que = "SELECT *FROM pimpinan WHERE jabatan='Rektor'";
$rektor = $conn->query($que);
$datarektor = $rektor->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a class="link" href=".">Pelengkap</a></li>
            </ol>
              ...
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-md-10 d-flex align-items-center">
                    <p class="text-sm text-dark">Informasi Semester Berjalan.</p>
                  </div>
                  <div class="col-md-2 text-end">
                    <a href="edit?id=<?php print_r($datatahun['idsemester']); ?>">
                      <i class="text-info material-icons opacity-10" data-bs-toggle="tooltip" data-bs-placement="top" title="Ubah Semester Berjalan">edit_calendar</i>
                    </a>
                  </div>
                </div>
                <div class="timeline timeline-one-side">
                  <div class="timeline-block mb-3">
                    ...
                    <div class="timeline-content">
                      ...
                      <p class="text-dark text-sm font-weight-bold mt-1 mb-0"><?php echo $datatahun['tahun']." Semester ".ucfirst($datatahun['semester']) ?></p>
                    </div>
                  </div>
                  <div class="timeline-block mb-3">
                    <span class="timeline-step">
                    ...
                    <tbody>
                      ...
                      if ($result->num_rows > 0) {
                        ...
                        <tr class="text-xs text-dark font-weight-bold">
                          <td>
                            <h6 class="mb-0 text-sm"><?php echo $row["jabatan"]; ?></h6>
                          </td>
                          <td>
                            <h6 class="mb-0 text-sm"><?php echo $row["nama"]; ?></h6>
                          </td>
                          <td class="text-center">
                            <a class="text-center" href="edit?id=<?php echo $row['idpimpinan']; ?>"><i class="material-icons text-warning text-gradient" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Data Pimpinan">edit</i></a>
                          </td>
                        </tr>
                        <?php
                        }
              ...
              <div class="card-body px-0 pb-2">
                <div class="table-responsive  mx-2">
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kode Program Studi</th>
                    ...
                    <tbody>
                      ...
                      if ($result->num_rows > 0) {
                        ...
                        <tr class="text-xs text-dark font-weight-bold">
                          <td class="text-center">
                            <h6 class="mb-0 text-sm"><?php echo $row["idprodi"]; ?></h6>
                          </td>
                          <td>
                            <h6 class="mb-0 text-sm"><?php echo $row["namaprodi"]; ?></h6>
                          </td>
                          <td class="text-center">
                            <h6 class="mb-0 text-sm"><?php echo $row["peringkat"]; ?></h6>
                          </td>
                          <td class="text-center">
                            <h6 class="mb-0 text-sm"><?php echo $row["nosk"]; ?></h6>
                          </td>
                          <td class="text-center">
                            <a class="text-center" href="edit?id=<?php echo $row['idprodi']; ?>"><i class="material-icons text-warning text-gradient" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Data Prodi">edit</i></a>
                          </td>
                        </tr>
                        <?php
                        }
