                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Persyaratan</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Status Layanan</th>
                    ...
                    <tr class="text-xs text-dark font-weight-bold">
                      <td class="text-center">
                        <div class="d-flex px-2 py-1">
                          <div><img src="../../assets/img/<?php echo $no.".png"; ?>" class="avatar-sm me-3" alt="atlassian" /></div>
                      ...
                      <td>
                        ...
                        ?>
                        <div class="d-flex flex-column justify-content-center">
                          <a class="text-center btn btn-sm bg-gradient-info mb-0 me-1 mt-2 mt-md-0" href="ajuanbaru/<?php echo "?idlayanan=$no"; ?>">BUAT AJUAN BARU</a>
                        </div>
                        <?php
                        } else {
                        ?>
                        <div class="d-flex flex-column justify-content-center">
                          <a class="text-center btn btn-sm bg-gradient-danger disabled mb-0 me-1 mt-2 mt-md-0" href="">BUAT AJUAN BARU</a>
                        </div>
                        <?php
                        }
                        ?>
