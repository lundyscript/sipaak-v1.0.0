      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a class="link" href=".">Dashboard</a></li>
          </ol>
            ...
            <div class="card-body p-3">
              <div class="row">
                <div class="col-md-10 d-flex align-items-center">
                  <p class="text-sm text-dark">Hi <span class="font-weight-bold text-capitalize"><?php print_r($data['nama']); ?></span>, Nice to meet you!</p>
                </div>
                <div class="col-md-2 text-end">
                  <a href="edit?nim=<?php print_r($data['npknim']); ?>"><i class="fas fa-user-edit text-info text-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Profile"></i>
                  </a>
                </div>
              </div>
              <div class="timeline timeline-one-side">
                ...
                <div class="timeline-block">
                  ...
                  <div class="timeline-content">
                    ...
                    <p class="text-dark text-sm font-weight-bold mt-1"><?php print_r(md5($akun['password'])); ?></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-8 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2 pb-0">
              ...
              <div class="text-end py-3">
                <h4 class="mb-0">Riwayat Ajuan</h4>
              </div>
            </div>
            <hr class="dark horizontal my-0" />
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nomor Pengajuan</th>
                  ...
                  <tbody>
                    <?php
                    $sql = "SELECT *FROM ajuan WHERE nim=$nim ORDER BY tanggal DESC";
                    $result = $conn->query($sql);
                    ...
                    ?>
                    <tr class="align-middle text-xs text-dark font-weight-bold">
                      <td class="text-left">
                        <div class="d-flex px-2 py-1">
                          <div><img src="../assets/img/<?php echo $row["idlayanan"].".png"; ?>" class="avatar-sm me-3" alt="atlassian" /></div>
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $namalayanan; ?></h6>
                          </div>
                        </div>
                      </td>
                      <td class="text-center"><?php echo $no; ?></td>
                      <td class="text-center"><?php echo $tgl1; ?></td>
                      ...
                      <td class="text-center">
                        ...
                        if($row["status"]=='SELESAI'){
                        ?>
                        <a class="text-center" href="layanan/riwayatajuan?idajuan=<?php echo $no; ?>"><i class="material-icons text-success text-gradient" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat">credit_score</i></a>
                        <?php
                        } else {
                        ?>
                        <a class="text-center" href="layanan/riwayatajuan?idajuan=<?php echo $no; ?>"><i class="material-icons text-info text-gradient" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat">visibility</i></a>
                        <?php
                        }
                        ?>
                      </td>
